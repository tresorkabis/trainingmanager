...
from progress.views.actions_views import ActionListViews, ActionDetailViews, ActionCreateView, ActionUpdateView, ActionDeleteView, ActionUpdateProgressionsView, ActionStagiairesPrintView
...
urlpatterns = [
    ...
    path("actions/<int:pk>/print-stagiaires/", ActionStagiairesPrintView.as_view(), name="action_stagiaires_print"),
    ...
    # Session Progressions (nested under module_progressions for logical grouping)
    ...
    path("module_progressions/<int:module_progress_pk>/sessions/<int:pk>/update/", SessionProgressUpdateView.as_view(), name="session_progress_update"),
    path("module_progressions/<int:module_progress_pk>/sessions/<int:pk>/delete/", SessionProgressDeleteView.as_view(), name="session_progress_delete"),

    # DetailActions (Inscriptions des stagiaires)
